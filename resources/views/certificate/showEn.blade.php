    ...
    <div class="certificate_wrapper">
        <div id="contentToCapture" class="main_wrapper">
            ...
            <div class="main_wrapper2">
                ...
                <div class="wrapper2">
                    <div class="left">
                        <p class="header">Owner: {{ $data->name_en }}</p>
                        <p class="header">Father: {{ $data->father_name_en }}</p>
                        <h4 style="color: #2C5F2D; margin-top:10px;" class="header">Holding No : &nbsp;
                            <span>{{ $data->permanent_holding_no }}</span>
                        </h4>
                    </div>
